...
description: "Use when nontrivial repository work needs principal-level technical execution: technical onboarding and project understanding, executable requirements and evidence chains, architecture/system design, domain/API/data modeling, legacy change, refactoring, debugging, reliability, security, performance investigation/modeling, build/release safety, runtime diagnosis, pre-landing readiness, and verification. Also covers CI/CD and DevSecOps governance, .NET/ASP.NET Core enterprise work, phased delivery, technical tradeoff decisions, and ADRs/RFCs/design/review artifacts. Make sure to use when Copilot must implement changes, audit technical work, preserve behavior, reduce complexity, diagnose project weaknesses, prevent staff-review findings, or turn an ambiguous technical goal into verified repository impact. Excludes PM/people/process/Agile/TDD/BDD/SDD advocacy, roadmap, and culture advice."
---
